...
window.EXPERIENCE_SOLUTIONS = [
  ...
  },
  {
    ...
    subtitle: "給台灣律師事務所的 Matter-centric AI 工作台：多案並行、期限不漏、人機雙簽——每一案一個可控的 AI 助理團隊，輸出必經律師簽核，引用必能點回法源。",
    ...
    compliance_note: "Synthetic／reference 基線（PoC）；非客戶 production、非勝訴率保證、非零幻覺保證；不取代律師最終法律判斷。",
    cta_text: "查看 AI 律師工作台展示",
    cta_href: "./experience/ai-lawyer-workbench/index.html",
    catalog_cta_href: "./ai-lawyer-workbench/index.html",
    pilot_program_text: "預約 10 分鐘 Demo",
    pilot_program_href: "./contact.html?request_type=ai_lawyer_demo&utm_source=site&utm_medium=ai_lawyer&utm_campaign=ai_lawyer_v1&utm_content=flagship",
    catalog_pilot_program_href: "../contact.html?request_type=ai_lawyer_demo&utm_source=site&utm_medium=ai_lawyer&utm_campaign=ai_lawyer_v1&utm_content=systems_catalog",
    primary_action: "pilot",
    contact_category: "experience_cta",
    contact_label: "experience_solution_view",
