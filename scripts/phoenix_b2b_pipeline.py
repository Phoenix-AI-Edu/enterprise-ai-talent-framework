...
def run_compile(client_name):
    ...
    CLIENT_CATALOG = {
        ...
        "okayama_electroplate": {
            ...
            "industry": "精密機械與傳統製造",
            "title": "某電鍍加工廠｜電鍍配方優化、廢水排污達標與化學師特許分紅案",
            "pain": "螺絲表面防鏽鋅鎳合金電鍍良率與環保廢水排污難以平衡。若追求高鹽霧良率，電鍍液添加的重金屬化學藥劑濃度就會偏高，導致廢水重金屬超標被開罰，年累計處罰與改善預算高達 120 萬元。",
            "resistance_strong": "配方防備與數據作假：",
            "resistance_desc": "首席化學工程師 (16 年年資) 擔心獨門藥水配方被 AI 學會後會被公司裁員失業，故意在系統中登錄偏差、殘缺的 pH 與化驗日誌，使配方演算法失效。",
            "solution_strong": "特許分紅與專利配方庫：",
            "solution_desc": "陳策略長設計「IP 特許授權合約」，承諾良率與排污達標後化學師可享 0.5% 季度營運分紅紅利並撥入退休帳戶；孟顧問將系統正名為「專利專家配方庫」，以尊嚴與利益對齊化解恐懼，成功收斂 LightGBM 配方與有人在環 (HITL) 雙簽安全網。",
            "roi_items": [
